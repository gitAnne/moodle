...
/**
 * URL authentication tests.
 *
 * @package    auth_url
 * @category   test
 * @copyright  2014 UP Learning, 2014 Gilles-Philippe Leblanc <gilles-philippe.leblanc@umontreal.ca>
...
global $CFG;
require_once($CFG->dirroot.'/auth/url/auth.php');

/**
 * URL authentication tests class.
 *
 * @package    auth_url
 * @category   test
 * @copyright  2014 UPLearning, 2014 Gilles-Philippe Leblanc <gilles-philippe.leblanc@umontreal.ca>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class auth_url_testcase extends advanced_testcase {

// TODO Implementation

    /** @var auth_plugin_url Keeps the authentication plugin. */
    ...
    protected function setUp() {
        ...
        $this->authplugin = new auth_plugin_url();
        ...
        $this->authplugin->config = get_config(auth_plugin_url::COMPONENT_NAME);
    }
    ...
    public function test_user_update_password() {
        ...
        $this->assertGreaterThanOrEqual($expectedtime, get_user_preferences('auth_url_passwordupdatetime', 0, $user->id));
    ...
    public function test_process_config() {
        ...
        $config = get_config(auth_plugin_url::COMPONENT_NAME);
