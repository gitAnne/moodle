...
class user_login_failed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserloginfailed', 'auth_url');
    }
    ...
    public function get_description() {
        ...
        $description .= "the reason '{$this->other['reason']}'.";        
        return $description;
    }
    ...
    public function get_url() {
        return new \moodle_url('/auth/url/logonrequest.php');
    }
    ...
    protected function get_legacy_logdata() {
        return array(SITEID, 'login', 'error', 'auth/url/logonrequest.php');
    }
